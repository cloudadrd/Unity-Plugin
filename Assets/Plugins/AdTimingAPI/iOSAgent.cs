...
public class iOSAgent : AdTimingAgent
{
    ...
    private static AdtInterstitialAdListener _insterstitialListener;
    private static AdtRewardedVideoListener _rewardedVideoListener;
    ...
    {
        AdtimingUtils.printLogI("setUserConsent:" + consent);
    ...
    {
        AdtimingUtils.printLogI("set interstitial listener" + interstitialAdListener);
    ...
    {
        AdtimingUtils.printLogI("interstitial callback type " + type);
        if (_insterstitialListener != null)
        {
            switch (type)
            {
                case OnADChangeAvailable:
                    {
                        AdtimingUtils.printLogI("interstitial change available "+code);
                ...
                case OnADOpen:
                    {
                        AdtimingUtils.printLogI("interstitial show " + extraData);
                ...
                case OnADClick:
                    {
                        AdtimingUtils.printLogI("interstitial click " + extraData);
                ...
                case OnADClose:
                    {
                        AdtimingUtils.printLogI("interstitial close " + extraData);
                ...
                case OnADShowFail:
                    {
                        AdtimingUtils.printLogI(string.Format("interstitial show faild {0} error {1}", extraData, code));
    ...
    {
        AdtimingUtils.printLogI("set rewardedVideo listener" + rewardedVideoListener);
    ...
    public static void iosAdTimingRewardedVideoCallback(int type, int code, string extraData)
    {
        if (_rewardedVideoListener != null)
        {
            switch (type)
            {
                case OnADChangeAvailable:
                    {
                        AdtimingUtils.printLogI("rewardedVideo change available "+code);
                ...
                case OnADOpen:
                    {
                        AdtimingUtils.printLogI("rewardedVideo open " + extraData);
                ...
                case OnADShow:
                    {
                        AdtimingUtils.printLogI("rewardedVideo show " + extraData);
                ...
                case OnADClick:
                    {
                        AdtimingUtils.printLogI("rewardedVideo click " + extraData);
                ...
                case OnADEnd:
                    {
                        AdtimingUtils.printLogI(string.Format("rewardedVideo end " + extraData));
                ...
                case OnADClose:
                    {
                        AdtimingUtils.printLogI(string.Format("rewardedVideo close " + extraData));
                ...
                case OnADRewarded:
                    {
                        AdtimingUtils.printLogI(string.Format("user get rewarded " + extraData));
                ...
                case OnADShowFail:
                    {
                        AdtimingUtils.printLogI(string.Format("rewardedVideo show faild {0} error {1}", extraData, code));
                        string errorMsg = "error code:" + code;
